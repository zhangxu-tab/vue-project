    ...
    <el-card>
      ...
      >
        <el-form-item label="属性名" prop="specsname">
          <el-input placeholder="请输入属性名" v-model="formData.specsname"></el-input>
        </el-form-item>
        <el-form-item label="属性值" prop="attrs">
          <div class="box" v-for="(item,index) in attrList" :key="index">
            ...
            <el-button @click="addAttr" type="success" v-if="index == 0">添加属性</el-button>
            <el-button @click="delAttr(index)" type="danger" v-else>删除属性</el-button>
          </div>
        </el-form-item>
